...
f = with_theme(
    ...
    f = Figure(size = (1000, 800))
    ga = f[1, 1] = GridLayout()
    ax4278 = Axis(ga[1, 1]; title = "4278 Å", xlabel = "t (s)", ylabel = "altitude (km)", yscale = log10)
    l4278_1 = lines!(t, data1; rasterize = true, label = "CFL 128")
    l4278_2 = lines!(t, data2; rasterize = true, label = "CFL 32")
