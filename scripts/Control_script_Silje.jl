...
root_savedir = "Pulsating_aurora"   # name for the root folder where data will be saved (data/root_savedir/)
name_savedir = "experiment_1"   # name for the actual data folder of the current experiment (data/root_savedir/name_savedir/...)
