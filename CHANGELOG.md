...
- **Numerical Breaking (small)** Minor correction of the Crank-Nicolson top boundary indexing/timing, which changes numerical results very slightly [#120](https://github.com/egavazzi/AURORA.jl/pull/120)
