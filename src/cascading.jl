...
# Q_matlab = @mget Q_matlab



# mat"
# tic
# integral2(fun,Es(i1),Edegmax,Emin,Eprime(end))
# toc
# "
...
# 24
# 42];
# Q_matlab = zeros(numel(Es),numel(Es),numel(Eionizations));
# E4Q = Es;
...
# tic
# for i3 = 5%numel(Eionizations):-1:1,
...
# Q_matlab(i2,i1,i3) = integral2(fun,Es(i1),Edegmax,Emin,Eprime(end));
# end
# end
# end
...
# M = rand(5000, 5000);
# @time file = matopen("test", "w")
# @time write(file, "M", M)
# @time close(file)

# @time file = matopen("test")
# @time M = read(file, "M")
# @time close